...
$totalEmpSQL = "SELECT * FROM cliente WHERE Cliente_Nome LIKE '%".$pesquisar."%'";
...
$empSQL = "SELECT * FROM cliente WHERE Cliente_Nome LIKE $pesquisa_teste ORDER BY ID_Cliente ASC LIMIT $startFrom, $showRecordPerPage";
...
<table id="myTable" width="1200" height="100">
    ...
    require ('conexao.php');
           ...
           function excluir(id)
           {
           if(confirm("Você realmente quer excluir o cliente com ID: "+id+"? Clique OK para confirmar ou Cancelar para tentar novamente.")){
