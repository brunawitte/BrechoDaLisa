...
$Cliente_Email = filter_input(INPUT_POST,'Cliente_Email');
$Cliente_Endereco = filter_input(INPUT_POST,'Cliente_Endereco');
$Cliente_CPF = filter_input(INPUT_POST,'Cliente_CPF');
$Cliente_CEP = filter_input(INPUT_POST,'Cliente_CEP');
$Cliente_Bairro = filter_input(INPUT_POST,'Cliente_Bairro');
$Cliente_Estado = filter_input(INPUT_POST,'Cliente_Estado');

$sql = "INSERT INTO cliente (Cliente_Nome,Cliente_Telefone,Cliente_Email,Cliente_Endereco,Cliente_CPF,Cliente_CEP,Cliente_Bairro,Cliente_Estado) VALUES ('$Cliente_Nome','$Cliente_Telefone','$Cliente_Email','$Cliente_Endereco','$Cliente_CPF','$Cliente_CEP','$Cliente_Bairro','$Cliente_Estado')";
