...
<div class="navbar">
  ...
  <a href="MostrarFornecedor.php">Fornecedores</a></div>
  </div> 
</div>
...
// $totalEmpSQL = "SELECT * FROM item INNER JOIN compras ON N_Compra = ID_Compra INNER JOIN cliente ON Compra_id_cliente = id_cliente ";
$totalEmpSQL = "SELECT * FROM compras";
...
<form action="RegistroCompras.php">
  <br>
        ...
        <input type="submit" class="button button2"  value="Cadastrar Novas Compras"></form>
