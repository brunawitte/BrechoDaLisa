...
$totalEmpSQL = "SELECT * FROM produto INNER JOIN status ON Produto_ID_Status = id_status INNER JOIN fornecedor ON Produto_ID_Fornecedor = id_fornecedor WHERE Produto_Nome LIKE $pesquisa_teste ORDER BY ID_Produto";
...
$pesquisa_teste = "'%".$pesquisar."%'";
$empSQL = "SELECT * FROM produto  INNER JOIN status ON Produto_ID_Status = id_status INNER JOIN fornecedor ON Produto_ID_Fornecedor = id_fornecedor WHERE Produto_Nome LIKE $pesquisa_teste ORDER BY ID_Produto  ASC LIMIT $startFrom, $showRecordPerPage";
