...
$totalEmpSQL = "SELECT * FROM fornecedor WHERE Fornecedor_Nome LIKE '%".$pesquisar."%'";
...
$empSQL = "SELECT * FROM fornecedor WHERE Fornecedor_Nome LIKE $pesquisa_teste ORDER BY ID_Fornecedor ASC LIMIT $startFrom, $showRecordPerPage";
...
<table id="myTable" width="1200" height="100">
   ...
   while($emp = mysqli_fetch_assoc($empResult)) { 
           ...
           function alterar(id)
           {
           if(confirm("Você realmente quer editar o fornecedor com ID: "+id+"? Clique OK para confirmar ou Cancelar para tentar novamente.")){
